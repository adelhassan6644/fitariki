          ...
          child: Column(
            children: [
              ...
              Consumer<RequestDetailsProvider>(builder: (_, provider, child) {
                return provider.isLoading?SizedBox() : Expanded(
                  child: Column(
                    children: [
                      Expanded(
                        child: ListAnimator(
                          data: [
                            ...
                            CalenderWidget(
                                startDate: provider.requestDetailsModel?.startAt??DateTime.now(),
                                endDate:  provider.requestDetailsModel?.endAt??DateTime.now(),
                                days: sl.get<ProfileProvider>().isDriver
                                    ?  provider.requestDetailsModel!.client!.clientDays!
                                    :  provider.requestDetailsModel!.driver!.driverDays!),
                            Padding(
                              padding: EdgeInsets.symmetric(
                                  vertical: 8.h,
                        ...
                        children: [
                          Padding(
                            ...
                            child: CustomButton(
                              ...
                              onTap: () =>
                                  provider.updateRequest(status: 1, id: 1),
                          ...
                          Padding(
                            ...
                            child: CustomButton(
                              ...
                              onTap: () => CupertinoPopUpHelper
                                  .showCupertinoTextController(
                                      title:
                                          getTranslated("negotiation", context),
                          ...
                          Padding(
                            ...
                            child: CustomButton(
                              ...
                              textColor: ColorResources.PRIMARY_COLOR,
                              onTap: () =>
                                  provider.updateRequest(status: 3, id: 1),
